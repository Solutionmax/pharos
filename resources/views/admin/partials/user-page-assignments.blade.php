<fieldset style="border:1px solid var(--line);border-radius:12px;padding:16px;min-width:0">
  ...
  <p class="help" style="margin-bottom:12px">Select the access checkbox and choose a role for each page. Read only allows viewing; editors manage operations; page administrators also manage branding, email and integrations. No selection means no page access. Administrators always have access to all pages.</p>
