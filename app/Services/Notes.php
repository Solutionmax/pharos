...
class Notes
{
    ...
    public const REGISTRY = [
        ...
        'integrations.no-heartbeats' => ['page' => 'Integrations › Bring in', 'route' => 'admin.integrations.in', 'params' => [], 'title' => 'No heartbeats yet'],
        'integrations.delivery' => ['page' => 'Integrations › Delivery log', 'route' => 'admin.integrations.log', 'params' => [], 'title' => 'How notification delivery and retries work'],
